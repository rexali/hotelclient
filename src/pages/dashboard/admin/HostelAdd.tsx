...
export default function HostelAdd({ handleAddHostel, setOpenHostel }: { setOpenHostel: any, handleAddHostel: (hostel: Hostel) => void }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        console.log('Submittted hostel data:', hostel, image);
        ...
        let hostelData = await addHostelAPI(formData);
    ...
    return (
        ...
        >
            <h2 className="text-2xl font-bold mb-4 text-gray-900 text-center flex justify-between">New Hostel <button onClick={() => setOpenHostel(false)}><Forward /></button></h2>
